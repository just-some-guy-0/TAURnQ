...
def main():
    ...
    ap.add_argument("--orbmin", type=float, default=40.0, help="Lower T (K) for Orbach guess (default 40 K)")
    ap.add_argument("--qtmmax", type=float, default=20.0, help="Upper T (K) for QTM guess (default 20 K)")
    args = ap.parse_args()
