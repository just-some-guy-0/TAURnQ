...
def main():
    ...
    ap.add_argument("--params_csv", default="NSiPr3.tsv_mc_params.csv", help="CSV with per-T MC outputs: T, Au,Uu,Ru,Nu,Qu, As,Us,Rs,Ns,Qs")
    ap.add_argument("--tsv", default = "NSiPr3.tsv", help="TSV/CSV with columns [T, tau_mu, alpha]")
    ...
    ap.add_argument("--RN_window", default="16,70", help="Tmin,Tmax for Raman (R,N) compilation")
    ap.add_argument("--Q_window",  default="72,120", help="Tmin,Tmax for QTM (Q) compilation")
