...
def main():
    ...
    ap.add_argument("--params_csv", default="6FPh.tsv_mc_params.csv", help="CSV with per-T MC outputs: T, Au,Uu,Ru,Nu,Qu, As,Us,Rs,Ns,Qs")
    ap.add_argument("--tsv", default = "6FPh.tsv", help="TSV/CSV with columns [T, tau_mu, alpha]")
    ...
    ap.add_argument("--AU_window", default="39,52.5", help="Tmin,Tmax for Orbach (A,Ueff) compilation, e.g. '45,58'")
    ap.add_argument("--RN_window", default="18,37.5", help="Tmin,Tmax for Raman (R,N) compilation")
