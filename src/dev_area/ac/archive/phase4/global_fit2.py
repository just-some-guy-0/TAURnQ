...
def main():
    ...
    ap.add_argument("--params_csv", default="NSi2iPr3.tsv_mc_params.csv", help="CSV with per-T MC outputs: T, Au,Uu,Ru,Nu,Qu, As,Us,Rs,Ns,Qs")
    ap.add_argument("--tsv", default = "NSi2iPr3.tsv", help="TSV/CSV with columns [T, tau_mu, alpha]")
    ...
    ap.add_argument("--AU_window", default="106,151", help="Tmin,Tmax for Orbach (A,Ueff) compilation, e.g. '45,58'")
    ap.add_argument("--RN_window", default="20,103", help="Tmin,Tmax for Raman (R,N) compilation")
    ap.add_argument("--Q_window",  default="2,10", help="Tmin,Tmax for QTM (Q) compilation")
