...
def main():
    ...
    ap.add_argument("--params_csv", default="tBuOCl.tsv_mc_params.csv", help="CSV with per-T MC outputs: T, Au,Uu,Ru,Nu,Qu, As,Us,Rs,Ns,Qs")
    ap.add_argument("--tsv", default = "tBuOCl.tsv", help="TSV/CSV with columns [T, tau_mu, alpha]")
    ...
    ap.add_argument("--AU_window", default="41,58", help="Tmin,Tmax for Orbach (A,Ueff) compilation, e.g. '45,58'")
    ap.add_argument("--RN_window", default="22,40", help="Tmin,Tmax for Raman (R,N) compilation")
    ap.add_argument("--Q_window",  default="9.7,20", help="Tmin,Tmax for QTM (Q) compilation")
