...
-11.528207224269245,2649.5862796513275,-5.741694182238611,3.0945031447690123,1.8709250426921669,0.0010004923297380463,88.18016513636012,2.4871065123247713,1.4146764445120084,0.6960985131257333,0.9947159291800285,-0.9813471325508902
)

# ---------- MC band config ----------
K = 50000
seed = 12345
Tg = np.linspace(2, 151, 400)

# Reference (original) curve to overlay ----> only from reta/chilton
A0, U0, R0, n0, Q0 = -11.55, 2651.7084,-5.5, 3.01, 1.83
