...
-8.17009913693008,840.1823752351822,-3.03300414398356,3.297913413570842,-0.8700282119220355,0.09870926758722576,2.2653059673068,0.5254139865684451,0.22912127119680492,0.5279605794059858,0.9912372032164933,-0.989813050887108
)

# ---------- MC band config ----------
K = 50000
seed = 12345
Tg = np.linspace(2, 120, 400)

# Reference (original) curve to overlay ----> only from reta/chilton
A0, U0, R0, n0, Q0 = -8.1675, 850,-3.0969, 3.3, -0.8692
...
plt.title(r"[Dy(N(SiiPr$_{3}$)$_{2}$)$_{2}$)]")
