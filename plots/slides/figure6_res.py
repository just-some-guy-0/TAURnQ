...
mu_U = 1800.0                    # pick a convenient scale (you can swap your fitted value here)
...
plt.plot(taus, pdf_fk,'k-', lw=3, label="Rate distribution")
plt.plot(taus, pdf_orb,"#FF0000", lw=1.5, linestyle= "--", label="Analytically-derived distribution")
plt.xscale("log")
plt.xlabel(r"Relaxation rate $(\tau^{-1})$")
